"""Ported from ghosttrace/tests/test_vector_store.py -- chunking,
embedding, and search behavior. Uses a real embedded Chroma client."""
from __future__ import annotations

import pytest

from configs.ghosttrace import CHUNK_CHARS, EMBED_DIM
from engines.ghosttrace_vector_store import VectorStore, chunk_text, embed
...
class TestSeedSearchRelevance:
    """The queries the demo video actually uses."""

    def test_nominee_query_finds_calloway_filing(self, store):
        from engines.ghosttrace_seed_data import SEED_FILINGS
