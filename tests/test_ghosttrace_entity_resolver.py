"""Ported from ghosttrace/tests/test_entity_resolver.py -- pure logic, no
network or DB. normalize_name/similarity come from shared/entity_resolver.py
(the reconciled version); resolve_entities/rewrite_links/the jurisdiction-
conflict guard are GhostTrace's own genuinely-distinct engine
(engines/ghosttrace_entity_resolver.py)."""

from __future__ import annotations

from engines.ghosttrace_entity_resolver import resolve_entities, rewrite_links
from shared.entity_resolver import normalize_name, similarity
