"""engines/deep_trace.py — ported from ghosttrace/deep_trace.py. Bounded
agentic loop for deeper ownership investigation.
...
from configs.ghosttrace import DEEP_TRACE_MAX_TOKENS, DEEP_TRACE_MAX_TOOL_CALLS
...
def _investigate_entity(entity_name: str, db: "Session") -> dict:
    from engines.ghosttrace_claude_extractor import ExtractorError, extract_entities
    ...
    try:
        filings = get_ownership_filings(cik)[:3]
    except EdgarError as exc:
