"""
engines/ghosttrace_claude_extractor.py — ported from
ghosttrace/claude_extractor.py. Claude Haiku integration.
...
from configs.ghosttrace import ADJUDICATION_MAX_TOKENS, EXTRACTION_MAX_TOKENS, REPORT_MAX_TOKENS
