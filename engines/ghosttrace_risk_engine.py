"""
engines/ghosttrace_risk_engine.py — ported verbatim from
ghosttrace/risk_engine.py (renamed on import only, to avoid colliding with
cfius_risk_engine.py / dib_risk_engine.py).

Deterministic risk scoring over a resolved ownership network. No web, no
database, no Claude. Every weight and threshold comes from
configs/ghosttrace.py. The LLM never touches scores: rules score, Claude
explains.
"""
