"""
engines/ghosttrace_graph_builder.py — ported verbatim from
ghosttrace/graph_builder.py (import paths only). Ownership network PNG via
NetworkX + matplotlib. No graphviz system dependency, just pip-installable
libraries.
"""
...
from engines.ghosttrace_risk_engine import jurisdiction_category  # noqa: E402
